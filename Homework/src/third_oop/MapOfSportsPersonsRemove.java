...
public class MapOfSportsPersonsRemove {
    Map<String, String> mapRunner = new HashMap<>();
    Map<String, String> mapSwimmer = new HashMap<>();

    //Remove an object from collection/map
    public void removeFromMapOfPersons() throws InputOptionException, FileNotFoundException {

        System.out.println("From which Map would you like to remove an object?" + "\n" + "Runners - press 1" + "\n" + "Swimmers - press 2"+ "\n" + "To exit program press 3");
        try {
            ...
            if (n == 1) {
                ...
                System.out.println("Input name (key) to remove:");
                mapRunner.remove(sc.next());
